...
| B1  | P1  | Bug       | Batch dialog should clone-on-edit like Recipe dialog                 | Swing batch dialog                                        | Done     | Draft `Batch` with OK apply / Cancel discard; inventory consume remains immediate exception                                               |
| B2  | P2  | Bug       | Batch Notes and Analysis layout wrong                                | Swing batch dialog                                        | Done     | Vertical, left-justified label-above scroll areas with equal `weighty`                                                                    |
| B3  | P2  | Bug       | Editing measurements does not refresh batch analysis                 | Swing batch dialog                                        | Done     | `refreshBatchAnalysis()` on measurement edit                                                                                              |
| B5  | P2  | Bug       | Edited measurements not shown as dirty (bold)                        | Swing batch dialog                                        | Done     | Measurements table bolds rows where draft measurement differs from live batch                                                             |
