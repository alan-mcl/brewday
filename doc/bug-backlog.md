...
| T4  | P0  | TODO      | Bitterness calc assumes 60-minute boil                               | `math/Equations.java` ~2798                               | Open     | `calcSolubleFermentableAdditionBitternessContribution` should scale for actual boil time                                                                                |
| T6  | P0  | TODO      | Ferment: fermentable additions not applied                           | `process/Ferment.java` ~228                               | Done     | Stale: `apply()` calls `applyFermentableAdditions(inputVolume)` before fermentation                                                                                     |
...
1. BeerXML import accuracy (**T1**–**T3**, **T8**, **T11**–**T12**)
2. Process engine gaps (**T4**, **T7**, **T14**–**T18**, **T21**, **T26**)
3. **`parseQuantity`** (**T13**)
