...
| T2  | P3  | TODO      | BeerXML import: decoction uses wrong mash volume                     | `BeerXmlParser.java` ~599                                 | Open     | Uses equipment mash-tun volume, not actual mash volume                                                                                                                   |
...
| T8  | P3  | TODO      | BeerXML import: ramp time ignored on first mash step                 | `BeerXmlParser.java` ~484                                 | Open     |                                                                                                                                                                          |
| T11 | P3  | TODO      | BeerXML import: fermentable colour Lovibond vs SRM                   | `BeerXmlRecipesHandler.java` ~1779                        | Open     | Spec mismatch; error likely small                                                                                                                                        |
...
| T13 | P1  | TODO      | `parseQuantity` is WIP; improve free-text quantity parsing           | `Brewday.java` ~793                                       | Open     | Javadoc notes work in progress                                                                                                                                           |
| T14 | P2  | TODO      | Sparge / infusion pH impact not modelled                             | `process/BatchSparge.java` ~242, `MashInfusion.java` ~169 | Open     | Infusion pH blend modelled; sparge mash pH still copied through                                                                                                          |
