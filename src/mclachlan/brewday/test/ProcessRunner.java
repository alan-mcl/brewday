...
public class ProcessRunner
{
	public static void main(String[] args) throws Exception
	{
		...
		grains.add(new Grain(34, 10, 6));
		GrainBill grainBill = new GrainBill(grains);
		Water water = new Water(15, 70);
		...
		process.add(new Boil("1", "boil 60m", null, "THE WORT", 60D));
		process.add(new Stand("2", "hop stand 30m", null, "THE WORT", 30D));
		process.add(new Dilute("3", "dilute to 20l", null, "THE WORT", 20, 5));
