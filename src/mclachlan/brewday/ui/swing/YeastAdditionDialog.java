...
public class YeastAdditionDialog extends JDialog implements ActionListener, KeyListener
{
	...
	public YeastAdditionDialog(Frame owner, String title, Recipe recipe)
	{
		...
		JLabel weightLabel = new JLabel(StringUtils.getUiString("yeast.weight"), JLabel.TRAILING);
		...
		if (recipe != null)
		{
			JLabel usageLabel = new JLabel(StringUtils.getUiString("yeast.addition.usage"));
			...
			JLabel timeLabel = new JLabel(StringUtils.getUiString("yeast.addition.time"));
