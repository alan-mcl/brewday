...
public class YeastScreen extends JPanel implements SwingScreen
{
	...
	YeastScreen(JFrame parent, DirtyStateService dirtyState, DialogPort dialogPort, DbPort dbPort, RenameHook renameHook)
	{
		...
		saveAction = commandAction("editor.apply.all", "yeast.save.action", SwingIcons.IconKey.SAVE, this::saveAll);
		undoAction = commandAction("editor.discard.all", "yeast.undo.action", SwingIcons.IconKey.UNDO, this::undoAll);
		...
		renameAction = commandAction("editor.rename", "yeast.rename.action", SwingIcons.IconKey.RENAME, this::renameSelected);
		...
		filterAction = commandAction("common.filter", "yeast.filter.action", SwingIcons.IconKey.FILTER, this::showFilterPanel);
