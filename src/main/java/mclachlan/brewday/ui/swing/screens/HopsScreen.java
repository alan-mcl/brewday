...
public class HopsScreen extends JPanel implements SwingScreen
{
	...
	HopsScreen(JFrame parent, DirtyStateService dirtyState, DialogPort dialogPort, DbPort dbPort, RenameHook renameHook)
	{
		...
		filterAction = commandAction("common.edit", "hop.filter.action", SwingIcons.IconKey.EDIT, this::showFilterPanel);
	...
	private void wireHotkeys()
	{
		...
		ActionHotkeySupport.bind(this, ActionHotkeySupport.ctrlOrCmd(KeyEvent.VK_S), "hop.hotkey.save", saveAction);
		ActionHotkeySupport.bind(this, ActionHotkeySupport.ctrlOrCmd(KeyEvent.VK_U), "hop.hotkey.undoU", undoAction);
		ActionHotkeySupport.bind(this, ActionHotkeySupport.ctrlOrCmd(KeyEvent.VK_Z), "hop.hotkey.undoZ", undoAction);
		...
		ActionHotkeySupport.bind(this, ActionHotkeySupport.ctrlOrCmd(KeyEvent.VK_D), "hop.hotkey.deleteCtrl", deleteAction);
