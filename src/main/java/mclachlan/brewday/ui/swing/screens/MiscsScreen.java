...
public class MiscsScreen extends JPanel implements SwingScreen
{
	...
	MiscsScreen(JFrame parent, DirtyStateService dirtyState, DialogPort dialogPort, DbPort dbPort, RenameHook renameHook)
	{
		...
		saveAction = commandAction("editor.apply.all", "misc.save.action", SwingIcons.IconKey.SAVE, this::saveAll);
		undoAction = commandAction("editor.discard.all", "misc.undo.action", SwingIcons.IconKey.UNDO, this::undoAll);
		...
		renameAction = commandAction("editor.rename", "misc.rename.action", SwingIcons.IconKey.RENAME, this::renameSelected);
		...
		filterAction = commandAction("common.filter", "misc.filter.action", SwingIcons.IconKey.FILTER, this::showFilterPanel);
