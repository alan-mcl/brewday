...
public class SwingYeastRehydratePane extends SwingProcessStepPane<YeastRehydrate>
{
	...
	public SwingYeastRehydratePane(DirtyStateService dirtyState, SwingRecipeTree recipeTree,
	...
	{
		addInputVolumeComboBox("volumes.in", YeastRehydrate::getInputVolume, YeastRehydrate::setInputVolume,
			Volume.Type.WORT);
		addTimeUnitControl("yeast.rehydrate.duration", YeastRehydrate::getDuration, YeastRehydrate::setDuration,
		...
		addComputedVolumePane("volumes.out", YeastRehydrate::getOutputVolume);
	}

	@Override
	protected void refreshInternal(YeastRehydrate step, Recipe recipe)
	{
	...
	private void commitCoolingCoefficient()
	{
		...
		YeastRehydrate s = getStepForTest();
		if (s == null)
		{
			return;
		}
