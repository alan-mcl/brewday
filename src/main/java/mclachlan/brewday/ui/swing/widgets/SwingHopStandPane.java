...
public class SwingHopStandPane extends SwingProcessStepPane<HopStand>
{
	...
	public SwingHopStandPane(DirtyStateService dirtyState, SwingRecipeTree recipeTree, boolean processTemplateMode)
	{
	...
	{
		addInputVolumeComboBox("volumes.in", HopStand::getInputVolume, HopStand::setInputVolume,
			Volume.Type.WORT);
		addTimeUnitControl("hop.stand.duration", HopStand::getDuration, HopStand::setDuration, Quantity.Unit.MINUTES);
		...
		addComputedVolumePane("volumes.out", HopStand::getOutputVolume);
	}

	@Override
	protected void refreshInternal(HopStand step, Recipe recipe)
	{
