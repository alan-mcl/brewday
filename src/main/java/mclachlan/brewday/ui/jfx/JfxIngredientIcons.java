...
/**
 * JavaFX icon lookup for fermentables/misc. Kept separate from {@code UiUtils}
 * so the Swing classpath is not dragged to JavaFX at class-init time for packages
 * omitting javafx jars.
 */
public final class JfxIngredientIcons
{
	private JfxIngredientIcons()
	{
	}
